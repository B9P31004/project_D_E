...
class grades(models.Model):
    ...
    school_year=models.IntegerField(validators=[MinValueValidator(1),MaxValueValidator(3)],verbose_name="学年",null=False,blank=False)
    semester=models.IntegerField(validators=[MinValueValidator(1),MaxValueValidator(3)],verbose_name="学期",null=False,blank=False)
    regular_test=models.CharField(validators=[check_regular_test],max_length=2,verbose_name="中間または期末",null=False,blank=False)
